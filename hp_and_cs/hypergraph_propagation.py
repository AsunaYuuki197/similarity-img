...
def prepare_hypergraph_propagation(root, dataset):
    ...
    try:
        graph_dir = root + '/' + graph_directaries[dataset]
    except:
        raise ValueError('only allow rparis, roxford, R1Moxford, and R1Mparis')    
