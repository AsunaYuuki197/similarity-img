...
def wrong_items(l, q, roxford):
    #l: list of retrievaled images
    #q: query index
    #roxford: ground truth dict
    #return: #wrong, list of wrong images
    
    gnd=roxford['gnd'][q]['easy']+roxford['gnd'][q]['hard']+roxford['gnd'][q]['junk']
    
    wrong=set(l)-set(gnd)
    return len(wrong),list(wrong)
