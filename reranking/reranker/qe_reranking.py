...
def aqe_reranking(query_features: np.ndarray, gallery_features: np.ndarray, kqe=4, DBA=False, kdba=4) -> np.ndarray:
    """Computes modified score matrix with AQE reranking method. AQE reranking method takes the original query + its top-kqe most similar gallery vectors and then average them and normalize to get modified score.
